...
export const Team: React.FC<TeamProps> = ({ onApplyLead }) => {
  ...
  return (
    <section id="leads" className="py-20 sm:py-28 bg-[#FFFFFF] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-6">
          ...
          {/* Filter Pills */}
          <div className="flex items-center gap-1.5 p-1.5 bg-[#F0F0F0] border-[2.5px] border-[#1E1E1E] rounded-2xl brutal-shadow-sm self-start sm:self-auto">
            <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredRoles.map((lead) => (
            <div
              key={lead.id}
              className="bg-[#FFFFFF] border-[2.5px] border-[#1E1E1E] rounded-[24px] p-6 brutal-shadow flex flex-col justify-between transition-all hover:-translate-y-1"
              style={{
                borderTopWidth: '8px',
            ...
            >
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="font-mono-code text-[11px] font-bold px-2.5 py-1 rounded-full border-[1.5px] border-[#1E1E1E] bg-[#CCF6C5] text-[#1E1E1E] flex items-center gap-1.5 shrink-0">
                ...
                <div>
                  <span className="font-mono-code text-[11px] font-bold text-[#1E1E1E]/80 uppercase block">
                    {lead.division}
                  </span>
                ...
                <div className="p-3.5 bg-[#F0F0F0] border-[1.5px] border-[#1E1E1E] rounded-xl text-xs text-[#1E1E1E]/90 leading-relaxed font-medium">
                  <span className="font-extrabold text-[#1E1E1E] block font-mono-code text-[11px] uppercase mb-1">
                    Sứ mệnh trọng tâm:
                  </span>
                  {lead.mission}
                </div>
                ...
                <div className="space-y-1.5">
                  <span className="font-mono-code text-xs font-bold text-[#1E1E1E]/90 uppercase block">
                    Nhiệm vụ lãnh đạo:
                  </span>
                  {lead.responsibilities.map((resp, i) => (
                    <div key={i} className="flex items-start gap-2 text-xs text-[#1E1E1E]/90">
                      <span className="font-mono-code text-xs font-extrabold text-[#4285F4] shrink-0 mt-0.5">
                        •
                      </span>
                      <span>{resp}</span>
                    </div>
              ...
              {/* Action Button */}
              <div className="pt-6 mt-4 border-t border-[#1E1E1E]/15">
                <button
                  onClick={() => onApplyLead(lead)}
                  className="w-full py-3.5 px-4 bg-[#1E1E1E] hover:bg-[#4285F4] text-[#FFFFFF] font-bold text-xs sm:text-sm font-mono-code rounded-xl border-[2.5px] border-[#1E1E1E] brutal-shadow-sm brutal-shadow-hover transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
        ...
        <div className="mt-14 p-6 sm:p-8 bg-[#C3ECF6] border-[2.5px] border-[#1E1E1E] rounded-[28px] brutal-shadow flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center sm:text-left">
            <h4 className="text-xl sm:text-2xl font-extrabold text-[#1E1E1E]">
              Bạn sẵn sàng trở thành Thủ Lĩnh Công Nghệ tiếp theo?
            </h4>
            <p className="text-xs sm:text-sm text-[#1E1E1E]/85 max-w-2xl font-medium">
          ...
          <button
            ...
            className="px-6 py-3.5 bg-[#FFFFFF] hover:bg-[#FFE7A5] text-[#1E1E1E] font-bold text-xs sm:text-sm font-mono-code rounded-full border-[2.5px] border-[#1E1E1E] brutal-shadow-sm brutal-shadow-hover shrink-0 cursor-pointer"
          >
