      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-[#FFE7A5] border-[2.5px] border-[#1E1E1E] rounded-[32px] p-8 sm:p-14 brutal-shadow-lg relative overflow-hidden">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#FFFFFF] border-[2px] border-[#1E1E1E] rounded-full text-xs font-mono-code font-bold text-[#EA4335] mb-6 shadow-sm">
            ...
            <span>"The GDGoC Impact Maker" trong AI Riser Vietnam 2026</span>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-4">
              ...
              <p className="text-sm sm:text-base text-[#1E1E1E]/90 max-w-2xl leading-relaxed font-normal">
              ...
              <div className="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs font-mono-code font-bold text-[#1E1E1E]">
                <div className="flex items-center gap-2 bg-[#FFFFFF]/90 p-2.5 rounded-xl border-[1.5px] border-[#1E1E1E]">
                ...
                <div className="flex items-center gap-2 bg-[#FFFFFF]/90 p-2.5 rounded-xl border-[1.5px] border-[#1E1E1E]">
                  <CheckCircle2 className="w-4 h-4 text-[#34A853] shrink-0" />
                  <span>Mạng lưới kết nối sinh viên & Google Mentors</span>
                </div>
              </div>
              ...
              <div className="pt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5">
                ...
                <a
                  href="#about"
                  className="inline-flex items-center justify-center gap-2 px-6 py-4 bg-[#FFFFFF] hover:bg-[#F0F0F0] text-[#1E1E1E] font-bold text-sm sm:text-base rounded-full border-[2.5px] border-[#1E1E1E] brutal-shadow-sm brutal-shadow-hover transition-all cursor-pointer"
                >
                  <span>Tìm Hiểu Về Sứ Mệnh GDGoC</span>
                </a>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 flex flex-col items-center">
              <div className="w-full bg-[#FFFFFF] border-[2.5px] border-[#1E1E1E] rounded-[28px] p-6 brutal-shadow text-center space-y-4">
                ...
                <div className="p-3 bg-[#F0F0F0] border-[1.5px] border-[#1E1E1E] rounded-xl text-xs font-mono-code text-[#1E1E1E] space-y-1 text-left">
                  <div><strong>Trụ sở:</strong> ĐH FPT TP.HCM (SHTP)</div>
                  <div><strong>Đối tượng:</strong> Tân Sinh Viên & Sinh Viên FPTU</div>
